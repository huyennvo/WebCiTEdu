...
for(let i = 0; i < 5; i++) {
  ...
  $( `tr.row${i + 2}` ).append(html2);
  //Ten classname của tr bn muons là gì row 2 rogifnma nma sao lai i + 2 ? u hiểu là row thứ i+2 là đc, i t cho chạy từ 0, giờ t muốn nó bắt đầu là row 2 ò chạy thử xem
}
  stt++;
});
