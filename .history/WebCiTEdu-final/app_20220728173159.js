$(document).ready(function () {
  $('#dataTable').on('click', '#select-all', function(){
    ...
    if ($(this).hasClass('allChecked')) {
      $('input:checkbox[id^=$(this).getAttribute('class')][type="checkbox"]').prop('checked', false);
    } else {
...
$(function() {
 ...
 $("#insertCol").click(function(){
  ...
  html1 +=`<th>Buổi ${stt} <button style="border: 0; background-color: #F8F9FC" id="select-all" class="${stt}"><i
...
html3 += `<td><input type="checkbox" id="checkBox${stt}" name="name" value="name">
<select name="cars" id="cars" >
  <option value="saab" selected></option>
    <option value="saab" >Có phép</option>
    <option value="opel">Không phép</option>
...
html4 += `<td><input type="checkbox" id="checkBox${stt}" name="name" value="name">
<select name="cars" id="cars" >
  <option value="saab" selected></option>
    <option value="saab" >Có phép</option>
    <option value="opel">Không phép</option>
...
html5 += `<td><input type="checkbox" id="checkBox${stt}" name="name" value="name">
<select name="cars" id="cars" >
  <option value="saab" selected></option>
    <option value="saab" >Có phép</option>
    <option value="opel">Không phép</option>
