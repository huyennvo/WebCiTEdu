$(document).ready(function() {
    ...
    $("#insertCol").click(function() {
        ...
        html1 += `<th id = ' + stt + '></th>Buổi ${stt} <button style="border: 0; background-color: #F8F9FC" id="select-all" class="checkBox${stt}"><i
  ...
  <select name="cars" id="cars" >
    ...
    $('#select-all1').click(function() {
        if ($(this).hasClass('allChecked')) {
            $('input:checkbox[id^=' + stt + '][type="checkbox"]').prop('checked', false);
        } else {
            $('input:checkbox[id^=' + stt + '][type="checkbox"]').prop('checked', true);
        }
