jQuery(document).ready(function() {
    ...
    $("#add-event").click("#add-new-event", function(e) {
        e.preventDefault();
        $form = $(e.currentTarget);
        $ename = $form.find('input#ename');
        $edate = $form.find('input#edate');
        $edesc = $form.find('textarea#edesc');
        $ID = '_' + Math.random().toString(36).substr(2, 9)
        events.push({
            id: $ID,
            ename: $ename.val(),
            edate: $form.find('input#event-start').val(),
