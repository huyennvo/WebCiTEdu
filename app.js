...
$(function() {
 ...
 $("#insertCol").click(function(){
  ...
  $('.select-all').click(function () {
    const stt = $(this).attr("data-stt");
    if ($(this).hasClass('allChecked')) {
      $(`input:checkbox[id^="checkBox${stt}"][type="checkbox"]`).prop('checked', false);
    } else {
      $(`input:checkbox[id^="checkBox${stt}"][type="checkbox"]`).prop('checked', true);
    }
    $(this).toggleClass('allChecked'); 
  })
  // on init
